...
if seccion == "Inicio":
    ...
    with c2:
        ...
        afectando la detección de eventos críticos.
        </div>""", unsafe_allow_html=True)
    with c3:
        st.markdown("""<div class="hallazgo-card">
    ...
    with tab1:
        ...
        with col_der:
            ...
            hallazgos = [
                ...
                (" V de Cramér",
                 "El TIPO tiene asociación moderada-fuerte con la gravedad. La MARCA tiene asociación débil."),
            ]
...
# ─────────────────────────────────────────────────────────────
    ...
    with tab_geo:
        ...
        with col2:
            ...
            lo que puede inflar artificialmente las tasas observadas en esas regiones.
            </div>
            """, unsafe_allow_html=True)
...
# ─────────────────────────────────────────────────────────────
    ...
    with col_lim:
        ...
        for l in ["Ausencia de velocidad, tipo de vía, alcohol y clima",
    ...
    with col_fut:
        ...
        for f in ["Incorporar narrativas textuales de reportes policiales (LLMs)",
